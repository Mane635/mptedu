...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "R"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "R"." ". ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span></td>
				</tr>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Grand Total<span class="inner-left-md"><?php echo "R"." ".$_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">PROCCED TO CHEKOUT</button><br>
							<a href="../promocode/makecode.php" target="blank" class="btn btn-upper btn-primary outer-left-xs">Get Discount Code</a>
